...
const TermsAndConditions: FC = () => {
  return (
    <Container className="py-5">
      <h1 className="h3">Terms and Conditions</h1>
      <p>Last updated: June 22, 2022</p>
      <p>
        Please read these terms and conditions carefully before using Our
        Service.
      </p>
      <h1 className="h4">Interpretation and Definitions</h1>
      <h2 className="h5">Interpretation</h2>
      <p>
      ...
      <h2 className="h5">Definitions</h2>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Ilse &amp; Oscar.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Ilse &amp; Oscar, accessible from{" "}
            <a
              href="https://bonos-wedding.web.app/"
              rel="external nofollow noopener noreferrer"
              target="_blank"
            >
              https://bonos-wedding.web.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <h1 className="h4">Acknowledgment</h1>
      <p>
      ...
      <h1 className="h4">Links to Other Websites</h1>
      <p>
      ...
      <h1 className="h4">Termination</h1>
      <p>
      ...
      <h1 className="h4">Limitation of Liability</h1>
      <p>
      ...
      <h1 className="h4">Governing Law</h1>
      <p>
      ...
      <h1 className="h4">Disputes Resolution</h1>
      <p>
      ...
      <h1 className="h4">For European Union (EU) Users</h1>
      <p>
        If You are a European Union consumer, you will benefit from any
        mandatory provisions of the law of the country in which you are resident
        in.
      </p>
      <h1 className="h4">United States Legal Compliance</h1>
      <p>
      ...
      <h1 className="h4">Severability and Waiver</h1>
      ...
      <h1 className="h4">Translation Interpretation</h1>
      <p>
      ...
      <h1 className="h4">Changes to These Terms and Conditions</h1>
      <p>
